        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-9 mb-3">
                    <h2>Financial Penunjang Bisnis - Biaya Umum</h2>
                </div>
                        ...
                        <table class="table table-borderless">
                            ...
                            <tbody class="fs-3">
                                <tr>
                                    ...
                                    <td>
                                        <div style="width: 75%;">
                                            <a href="{{url('/financial/penunjang-bisnis/biaya-umum/detail')}}" class="btn btn-dribbble form-control mx-3">View</a>
                                        </div>
                                    </td>
                                </tr>
                            </tbody>
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title">Filter by Date - Biaya Umum</h5>
