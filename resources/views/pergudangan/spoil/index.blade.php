    ...
    <div class="card">
        <div class="card-body">
            <p>
                ...
                <a href="" class="text-decoration-underline">Data spoil penyimpanan produk</a>
            </p>
        </div>
    </div>
</div>
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-9 mb-3">
                    <h2>Data Spoil Penyimpanan Produk</h2>
                </div>
                        ...
                        <table class="table table-borderless">
                            ...
                            <tbody class="fs-3">
                                <tr>
                                    ...
                                    <td>
                                        <div style="width: 75%;">
                                            <a href="{{url('/warehouse/spoil/detail')}}" class="btn btn-dribbble form-control mx-2">View</a>
                                        </div>
                                    </td>
                                </tr>
                            </tbody>
