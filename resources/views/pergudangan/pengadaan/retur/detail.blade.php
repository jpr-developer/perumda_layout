...
<div class="col-md-12">
    <div class="card shadow-sm">
        <div class="card-body">
            <a href="{{url('/warehouse/pengadaan/retur')}}" class="text-decoration-underline fs-2 fw-bold">Retur Pemesanan</a>
            ...
            <div class="mb-3">
                ...
                <div class="table-responsive">
                    <table class="fs-3 table-md table table-borderless">
                        <tr>
                            <td>ID Retur Pemesanan</td>
                            <td class="text-end">RT/RO.123456789</td>
                        </tr>
                        <tr>
                            <td>ID Pembayaran</td>
