...
<div class="col-md-12">
    <div class="card shadow-sm">
        <div class="card-body">
            <a href="{{url('/kegiatan')}}" class="text-decoration-underline fs-2 fw-bold">Kegiatan</a>
...
<div class="col-md-12">
    <div class="card">
        <div class="card-body">
            <h3>Taggal Kegiatan : Selasa, 20 Mei 2022</h3>
            <h3>ID Kegiatan : TR.123456789</h3>
            <h3>Status Kegiatan : Terlaksana</h3>

            <div class="table-responsive">
                <table class="table table-bordered">
                    <thead class="card-table">
                        <th style="width: 2%" class="rounded-start">
                        ...
                        <th style="width: 35%" class="text-center rounded-end">
                            <div class="form-control">
                                Keterangan
                            </div>
                        </th>
