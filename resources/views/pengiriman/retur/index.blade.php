...
<div class="col-md-12 mb-3">
    <div class="card shadow-sm">
        <div class="card-body">
            <p>
                <font class="fs-1 fw-bold">Retur Pengiriman Produk</font> <br>
                <span>Data retur pengiriman produk</span>
            </p>
        </div>
    </div>
</div>
            ...
            <div class="row">
                <div class="col-md-12 mb-3">
                    <div class="d-flex justify-content-between align-items-center">
                        <h2>Data Retur Pengiriman Produk</h2>
                        <div>
                        ...
                        <table class="table table-borderless">
                            ...
                            <tbody class="fs-3">
                                <tr>
                                    ...
                                    <td>
                                        <div style="width: 75%;">
                                            <a href="{{url('/pengiriman/retur/detail')}}" class="btn btn-dribbble form-control mx-3">View</a>
                                        </div>
                                    </td>
                                </tr>
                            </tbody>
