...
<div class="col-md-12">
    <div class="card">
        <div class="card-body">
            <p>
                <font class="fs-1 fw-bold">Pengiriman Produk</font> <br>
                <a href="" class="text-decoration-underline">Data pengiriman produk</a>
            </p>
        </div>
    </div>
</div>
                        ...
                        <table class="table table-borderless">
                            ...
                            <tbody class="fs-3">
                                <tr>
                                    ...
                                    <td>
                                        <div style="width: 75%;">
                                            <a href="{{url('/pengiriman/permintaan/detail')}}" class="btn btn-dribbble form-control mx-2">View</a>
                                        </div>
                                    </td>
                                </tr>
                            </tbody>
