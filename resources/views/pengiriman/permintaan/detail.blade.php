...
<div class="col-md-12">
    <div class="card shadow-sm">
        <div class="card-body">
            <a href="{{url('/pengiriman/permintaan')}}" class="text-decoration-underline fs-2 fw-bold">Pengiriman Produk</a>
...
<div class="col-md-12">
    <div class="card">
        <div class="card-body">
            <h3>Taggal Pengiriman : Selasa, 20 Mei 2022</h3>
            <h3>ID Pengiriman : TR.123456789</h3>
            ...
            <div class="mt-4">
                ...
                <table class="table table-borderless fs-3">
                    ...
                    <tr>
                        ...
                        <td>
                            : <span class="badge bg-danger">Perjalanan</span>
                        </td>
                    </tr>
                </table>
            </div>
