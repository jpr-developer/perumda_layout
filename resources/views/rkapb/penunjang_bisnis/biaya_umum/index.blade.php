        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-9 mb-3">
                    <h2>RKAPB Tahun 2023 - Biaya Umum</h2>
                </div>
                        ...
                        <table class="table table-borderless">
                            ...
                            <tbody class="fs-3">
                                <tr>
                                    ...
                                    <td>
                                        <span class="form-control border border-0 fs-3">Biaya Reparasi dan Pemel. Mesin</span>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="form-control border border-0 fs-3">Biaya Reparasi dan Pemel. Kendaraan</span>
                                    </td>
                                    <td>
                                        <span class="form-control border border-0 fs-3">Rp 729.166</span>
                                    </td>
                                    <td>
                                        <span class="form-control border border-0 fs-3">Rp 8.750.000</span>
                                    </td>
                                    <td>
                                        <span class="form-control border border-0 fs-3">
                                            Lorem Ipsum is simply dummy text of the printing and typesetting industry.
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title">Filter RKAPB - Biaya Umum</h5>
