        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-9 mb-3">
                    <h2>RKAPB Tahun 2023 - Biaya Kantor</h2>
                </div>
                        ...
                        <table class="table table-borderless">
                            ...
                            <tbody class="fs-3">
                                <tr>
                                    ...
                                    <td>
                                        <span class="form-control border border-0 fs-3">Rp 8.500.000</span>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="form-control border border-0 fs-3">Biaya Pos dan Telepon</span>
                                    </td>
                                    <td>
                                        <span class="form-control border border-0 fs-3">Rp 200.000</span>
                                    </td>
                                    <td>
                                        <span class="form-control border border-0 fs-3">Rp 2.400.000</span>
                                    </td>
                                    <td>
                                        <span class="form-control border border-0 fs-3">
                                            Lorem Ipsum is simply dummy text of the printing and typesetting industry.
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title">Filter RKAPB - Biaya Kantor</h5>
