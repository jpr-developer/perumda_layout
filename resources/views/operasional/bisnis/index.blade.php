    ...
    <div class="card">
        <div class="card-body">
            <p>
                ...
                <a href="" class="text-decoration-underline">Data operasional bisnis</a>
            </p>
        </div>
    </div>
</div>
                        ...
                        <table class="table table-borderless">
                            ...
                            <tbody class="fs-3">
                                <tr>
                                    ...
                                    <td>
                                        <div style="width: 75%;">
                                            <a href="{{url('/operasional/bisnis/detail')}}" class="btn btn-dribbble form-control mx-2">View</a>
                                        </div>
                                    </td>
                                </tr>
                            </tbody>
